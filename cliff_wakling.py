...
class CliffWalking(CliffWalkingEnv):
    def __init__(self, is_hardmode=True, num_cliffs=10, *args, **kwargs):
        ...
        for s in range(self.nS):
            ...
            self.P[s][LEFT] = self._calculate_transition_prob(position, [
                                                              0, -1])
        ...
        while frontier:
            ...
            if not (r, c) in discovered:
                ...
                for x, y in directions:
                    r_new = r + x
                    c_new = c + y
                    if r_new < 0 or r_new >= self.shape[0] or c_new < 0 or \
                            c_new >= self.shape[1]:
                        continue
    ...
    def _render_gui(self, mode):
        ...
        if self.window_surface is None:
            ...
            if mode == "human":
                ...
                pygame.display.set_caption(
                    "CliffWalking - Edited by Audrina & Kian")
        ...
        if self.elf_images is None:
            ...
            self.elf_images = [
                pygame.transform.scale(
                    pygame.image.load(f_name), self.cell_size)
        ...
        for s in range(self.nS):
            ...
            self.window_surface.blit(
                self.mountain_bg_img[check_board_mask], pos)
            ...
            if s == self.s:
                ...
                last_action = self.lastaction if self.lastaction is not None else 2  # noqa E501
